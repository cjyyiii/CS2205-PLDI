...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TM_LEFT_BRACKET = 262,         /* TM_LEFT_BRACKET  */
    TM_RIGHT_BRACKET = 263,        /* TM_RIGHT_BRACKET  */
    TM_LEFT_PAREN = 264,           /* TM_LEFT_PAREN  */
    TM_RIGHT_PAREN = 265,          /* TM_RIGHT_PAREN  */
    TM_SEMICOL = 266,              /* TM_SEMICOL  */
    TM_VAR = 267,                  /* TM_VAR  */
    TM_ARRAY = 268,                /* TM_ARRAY  */
    TM_IF = 269,                   /* TM_IF  */
    TM_THEN = 270,                 /* TM_THEN  */
    TM_ELSE = 271,                 /* TM_ELSE  */
    TM_WHILE = 272,                /* TM_WHILE  */
    TM_DO = 273,                   /* TM_DO  */
    TM_ASGNOP = 274,               /* TM_ASGNOP  */
    TM_OR = 275,                   /* TM_OR  */
    TM_AND = 276,                  /* TM_AND  */
    TM_NOT = 277,                  /* TM_NOT  */
    TM_LT = 278,                   /* TM_LT  */
